...
class mts_related_posts_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			sprintf( __('%sRelated Posts', 'best' ), MTS_THEME_WHITE_LABEL ? '' : 'MTS ' ),
			array( 'description' => __( 'Display the related posts from current post\'s categories. Will appear on single posts only.', 'best' ) )
		);
	}
	...
	public function form( $instance ) {
		...
		$title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : __( 'Related Posts', 'best' );
		...
		<p>
			<label for="<?php echo $this->get_field_id("comment_num"); ?>">
				...
				<?php _e( 'Show number of comments', 'best' ); ?></p>
			</label>
		</p>
