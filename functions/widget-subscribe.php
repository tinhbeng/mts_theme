...
/*-----------------------------------------------------------------------------------*/
	...
	function mts_Subscribe_Widget() {
		...
		/* Create the widget. */
		parent::__construct( 'mts_subscribe_widget', __('MyThemeShop: Subscribe Widget', 'mythemeshop'), $widget_ops, $control_ops );
	}
...
/*-----------------------------------------------------------------------------------*/
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'desc' ); ?>"><?php _e('Feedburner id (<span style="color: #C6C6C6;">http://feeds.feedburner.com/</span><b>mythemeshop</b>):', 'mythemeshop') ?></label>
