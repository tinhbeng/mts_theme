...
jQuery( window ).load(function() {
	...
	if ( jQuery('.widget-slider-bullets').length ) {
		jQuery('.widget-slider-bullets').each(function() {
			var widgetSlider = jQuery(this);
				widgetSliderContainer = widgetSlider.closest('.owl-container');
	...
	if(jQuery('.bh-client').length){
		jQuery('.bh-client').owlCarousel({
		    loop:true,
		    margin:50,
		    nav:true,
		    autoplay: 1000,
	...
	if ( jQuery('#footer-post-carousel').length ) { // Footer carousel
		jQuery('#footer-post-carousel').each(function(){
			var footerCarousel = jQuery(this),
				footerCarouselContainer = footerCarousel.closest('.owl-container');
			...
			footerCarousel.owlCarousel({
				...
				dots: false,
				onInitialized: function(){
					footerCarouselContainer.removeClass('loading');
				},
				rewindNav: false,
				responsive:{
	            	0:{
		...
		jQuery('#footer-post-carousel .footer-carousel-item > a').click(function(e) {
			var $this = jQuery(this);
			if ( ! $this.parent().hasClass('show-post-data') ) {
				e.preventDefault();
				$this.parent().parent().parent().find('.show-post-data').removeClass('show-post-data');
